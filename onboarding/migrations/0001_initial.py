# Generated by Django 3.0.1 on 2020-04-15 10:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('s', 'sent'), ('d', 'done')], default='s', help_text='user status', max_length=1)),
        ...
        migrations.AddField(
            model_name='package',
            name='email',
            field=models.ManyToManyField(blank=True, through='onboarding.Status', to='onboarding.Email'),
        ),
        migrations.AddField(
            model_name='package',
            name='owner',
