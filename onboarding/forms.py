...
class HrSignUpFormEng(UserCreationForm):
    ...
    password1 = forms.CharField(max_length=50,  label='Password',
        help_text='''Please type your password. It
    ...
    password2 = forms.CharField(max_length=50, label='Re-type password',
        help_text='Please re-type your password.',
        widget=forms.PasswordInput(attrs={'class': 'form-control'}))
...
class HrSignUpForm(UserCreationForm):
    ...
    first_name = forms.CharField(max_length=50, label='Podaj imię',
    ...
    password1 = forms.CharField(max_length=50, label='Podaj hasło',
        help_text='''Hasło nie może być krótsze niż 8 znaków, zbyt łatwe do
        odgadnięcia, ani składać się wyłącznie z cyfr.''',
        widget=forms.PasswordInput(attrs={'class': 'form-control'}))
    password2 = forms.CharField(max_length=50, label='Powtórz hasło',
